...
#define BSP_LED2_PIN                          (0U)
#define BSP_LED2_PORT                         (gpioPortA)

#define BSP_LED3_PIN                          (0U)
#define BSP_LED3_PORT                         (gpioPortD)

#define BSP_LED4_PIN                          (1U)
#define BSP_LED4_PORT                         (gpioPortD)

#define BSP_LED5_PIN                          (2U)
#define BSP_LED5_PORT                         (gpioPortD)

#define BSP_LED_COUNT                         (6U)
#define BSP_LED_INIT                          { { BSP_LED0_PORT, BSP_LED0_PIN }, { BSP_LED1_PORT, BSP_LED1_PIN }, { BSP_LED2_PORT, BSP_LED2_PIN }, { BSP_LED3_PORT, BSP_LED3_PIN }, { BSP_LED4_PORT, BSP_LED4_PIN }, { BSP_LED5_PORT, BSP_LED5_PIN } }
#define HAL_LED_COUNT                         (6U)
#define HAL_LED_ENABLE                        { 0,1,2,3,4,5 }
